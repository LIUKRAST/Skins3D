...
public class CustomPlayerModel {
    ...
    public static ModelData getCustomPlayerBasicShape(Dilation dilation, float pivotOffsetY) {
        ...
        modelPartData.addChild(EntityModelPartNames.HAT,
                layering(50, dilation, 32, 0, -4.0f, -8.0f, -4.0f, 8.0f, 8.0f, 8.0f)
    ...
    public static ModelData getCustomPlayerFinalShape(Dilation dilation, boolean slim) {
        ...
        ModelPartBuilder SLIM_LEFT_SLEEVE_3D = layering(25, dilation, 48, 48, -1.0f, -2.0f, -2.0f, 3.0f, 12.0f, 4.0f);
        ModelPartBuilder SLIM_RIGHT_SLEEVE_3D = layering(25, dilation, 40, 32, -2.0f, -2.0f, -2.0f, 3.0f, 12.0f, 4.0f);

        ModelPartBuilder LEFT_SLEEVE_3D = layering(25, dilation, 48, 48, -1.0f, -2.0f, -2.0f, 4.0f, 12.0f, 4.0f);
        ModelPartBuilder RIGHT_SLEEVE_3D = layering(25, dilation, 40, 32, -3.0f, -2.0f, -2.0f, 4.0f, 12.0f, 4.0f);

        ModelPartBuilder LEFT_PANTS_3D = layering(25, dilation, 0, 48, -2.0f, 0.0f, -2.0f, 4.0f, 12.0f, 4.0f);
        ModelPartBuilder RIGHT_PANTS_3D = layering(25, dilation, 0, 32, -2.0f, 0.0f, -2.0f, 4.0f, 12.0f, 4.0f);
        ModelPartBuilder JACKET_3D = layering(25, dilation, 16, 32, -4.0f, 0.0f, -2.0f, 8.0f, 12.0f, 4.0f);
